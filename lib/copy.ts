...
export const copy = {
  zh: {
    ...
    pricingProPrice: '29 美元',
    pricingProNote: '终身授权，一次买断',
    pricingProItems: [
      '包含 Free 的全部能力',
      '工作区方案捕获和归位',
      '标题栏悬停置顶',
    ...
    pricingCta: '购买 Pro',
    pricingFine: '由 Creem 收款并开具发票。授权码会发到邮箱，也可在这台 Mac 上激活。',
    ...
    successEmail: '同一枚授权码会写在付款确认邮件里。换电脑前，先在旧电脑上停用。',
    successCopy: '复制授权码',
    successCopied: '已复制',
  ...
  en: {
    ...
    pricingProName: 'ZoneBox Pro',
    pricingProPrice: 'US$29',
    pricingProNote: 'Pay once, keep it',
    pricingProItems: [
      'Everything in Free',
    ...
    pricingCta: 'Buy Pro',
    pricingFine: 'Creem handles checkout and invoices. The license key is emailed, and you can activate it on this Mac.',
    ...
    successEmail: 'The same key is in the payment email. Deactivate this Mac before moving the license to another one.',
